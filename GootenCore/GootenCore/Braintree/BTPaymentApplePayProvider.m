...
@interface BTPaymentApplePayProvider () <PKPaymentAuthorizationViewControllerDelegate, PKPaymentAuthorizationViewControllerDelegate>
...
- (void)authorizeApplePay {
    ...
    if ([[self class] isSimulator]) {
        paymentAuthorizationViewController = ({
            PKPaymentAuthorizationViewController *mockVC = [[PKPaymentAuthorizationViewController alloc] initWithPaymentRequest:paymentRequest];
...
- (void)mockApplePayPaymentAuthorizationViewController:(__unused PKPaymentAuthorizationViewController *)viewController
                                   didAuthorizePayment:(PKPayment *)payment
                                            completion:(void (^)(PKPaymentAuthorizationStatus))completion {
    [self applePayPaymentAuthorizationViewControllerDidAuthorizePayment:payment
                                                             completion:completion];
...
- (void)mockApplePayPaymentAuthorizationViewControllerDidFinish:(PKPaymentAuthorizationViewController *)viewController {
